...
export default ({ updateFrom, issuesType, handleSelectTitle }) => {
  ...
  const domSelectElem = {
    selectItems: document.querySelector(
      `[data-select-type=select-items-${issuesType}]`
    ),
    selectField: document.querySelector(
      `[data-issue-type=select-field-${issuesType}]`
    ),
  };
  ...
  const handleItemClick = (e) => {
    ...
    const taskTitle = updateFrom.issues.find(
  ...
  return (
    <>
      <div className="custom-select-container">
        <div
          className="custom-select-field select-icon--down"
        ...
        <div
          className="custom-select-items hide"
          data-select-type={`select-items-${issuesType}`}
        >
